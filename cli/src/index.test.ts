...
test("runCli initializes vue3 projects", async () => {
  ...
  try {
    ...
    assert.match(await readFile(join(cwd, "web-app", "README.md"), "utf8"), /Generated by Tsu from the `vue3` template/);
...
test("runCli initializes react projects", async () => {
  ...
  try {
    ...
    assert.match(await readFile(join(cwd, "react-app", "README.md"), "utf8"), /Generated by Tsu from the `react` template/);
