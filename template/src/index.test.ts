...
test("mfe-main template creates React qiankun host skeleton files", () => {
  ...
  assert.match(app, /This Phase 2 host skeleton/);
  assert.match(readme, /Generated by Tsu from the `mfe-main` template/);
  assert.match(readme, /Phase 2 React qiankun host shell starter/);
  assert.match(readme, /Tailwind CSS/);
  assert.match(readme, /ESLint/);
  assert.match(readme, /Prettier/);
  assert.match(readme, /Phase 3 adds auth state and real qiankun registration/);
