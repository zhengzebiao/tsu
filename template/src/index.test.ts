...
test("monorepo template creates workspace files", () => {
  ...
  assert.ok(paths.includes("components/vue/tsconfig.json"));
  assert.ok(paths.includes("components/vue/src/index.ts"));
  assert.ok(paths.includes("components/react/tsconfig.json"));
  assert.ok(paths.includes("components/react/src/index.ts"));
  assert.match(files.find((file) => file.path === "utils/package.json")?.content ?? "", /"\.\/js"/);
  assert.ok(paths.includes("utils/js/tsconfig.json"));
  assert.ok(paths.includes("utils/js/src/index.ts"));
  assert.ok(paths.includes("template/tsconfig.json"));
  assert.ok(paths.includes("template/src/index.ts"));
