...
test("mfe template creates qiankun workspace files", () => {
  ...
  assert.match(files.find((file) => file.path === "README.md")?.content ?? "", /Sub App Entry Configuration/);
  assert.match(files.find((file) => file.path === "README.md")?.content ?? "", /Host and Sub App Communication/);
  assert.match(files.find((file) => file.path === "README.md")?.content ?? "", /Micro Frontend Choice Guide/);
});
