...
This is the Phase 7 React qiankun sub application starter. It runs independently, exposes concrete qiankun lifecycle functions, stores host props in a local Zustand wrapper, includes React Query-ready business page structure, ships Vitest, Testing Library, and Playwright coverage by default, and includes Docker, nginx, and compose deployment assets.
...
| \`apps/app/src/pages/BusinessHomePage.tsx\` | Phase 7 starter business page using host props, state, and query data |
